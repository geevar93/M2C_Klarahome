...
/**
 * The storefront's accessibility floor, asserted in a real browser.
 *
 * There is no visible UI to test yet — the header, navigation and pages arrive at Step 23 — but
