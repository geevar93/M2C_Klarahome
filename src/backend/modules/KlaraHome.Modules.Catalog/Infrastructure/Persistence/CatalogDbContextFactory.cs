...
internal sealed class CatalogDbContextFactory : IDesignTimeDbContextFactory<CatalogDbContext>
{
    ...
    public CatalogDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, CatalogModule.SchemaName);

        return new CatalogDbContext(builder.Options, new DesignTimeTenantContext());
    }
