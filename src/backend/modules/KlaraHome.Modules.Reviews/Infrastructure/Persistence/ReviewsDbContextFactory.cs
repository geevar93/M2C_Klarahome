...
internal sealed class ReviewsDbContextFactory : IDesignTimeDbContextFactory<ReviewsDbContext>
{
    ...
    public ReviewsDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, ReviewsModule.SchemaName);

        return new ReviewsDbContext(builder.Options, new DesignTimeTenantContext());
    }
