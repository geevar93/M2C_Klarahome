...
internal sealed class PricingDbContextFactory : IDesignTimeDbContextFactory<PricingDbContext>
{
    ...
    public PricingDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, PricingModule.SchemaName);

        return new PricingDbContext(builder.Options, new DesignTimeTenantContext());
    }
