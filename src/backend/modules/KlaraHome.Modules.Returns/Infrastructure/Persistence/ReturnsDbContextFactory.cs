...
/// </remarks>
internal sealed class ReturnsDbContextFactory : IDesignTimeDbContextFactory<ReturnsDbContext>
{
    ...
    public ReturnsDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, ReturnsModule.SchemaName);

        return new ReturnsDbContext(builder.Options, new DesignTimeTenantContext());
    }
