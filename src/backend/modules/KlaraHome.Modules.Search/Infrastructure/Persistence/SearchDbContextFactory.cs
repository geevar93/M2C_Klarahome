...
internal sealed class SearchDbContextFactory : IDesignTimeDbContextFactory<SearchDbContext>
{
    ...
    public SearchDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, SearchModule.SchemaName);

        return new SearchDbContext(builder.Options, new DesignTimeTenantContext());
    }
