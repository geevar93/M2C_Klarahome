...
internal sealed class ReportingDbContextFactory : IDesignTimeDbContextFactory<ReportingDbContext>
{
    ...
    public ReportingDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, ReportingModule.SchemaName);

        return new ReportingDbContext(builder.Options, new DesignTimeTenantContext());
    }
