...
internal sealed class NotificationsDbContextFactory : IDesignTimeDbContextFactory<NotificationsDbContext>
{
    ...
    public NotificationsDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, NotificationsModule.SchemaName);

        return new NotificationsDbContext(builder.Options, new DesignTimeTenantContext());
    }
