...
internal sealed class PaymentsDbContextFactory : IDesignTimeDbContextFactory<PaymentsDbContext>
{
    ...
    public PaymentsDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, PaymentsModule.SchemaName);

        return new PaymentsDbContext(builder.Options, new DesignTimeTenantContext());
    }
