...
internal sealed class InventoryDbContextFactory : IDesignTimeDbContextFactory<InventoryDbContext>
{
    ...
    public InventoryDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, InventoryModule.SchemaName);

        return new InventoryDbContext(builder.Options, new DesignTimeTenantContext());
    }
