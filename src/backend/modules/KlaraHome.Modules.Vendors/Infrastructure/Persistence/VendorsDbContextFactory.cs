...
/// </para>
/// </remarks>
internal sealed class VendorsDbContextFactory : IDesignTimeDbContextFactory<VendorsDbContext>
{
    ...
    public VendorsDbContext CreateDbContext(string[] args)
    {
        ...
        var builder = new DbContextOptionsBuilder<VendorsDbContext>();
        builder.ConfigureKlaraHome(provider: null, connectionString, VendorsModule.SchemaName);

        return new VendorsDbContext(builder.Options, new DesignTimeTenantContext());
    }
