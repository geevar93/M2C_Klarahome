...
internal sealed class ContentDbContextFactory : IDesignTimeDbContextFactory<ContentDbContext>
{
    ...
    public ContentDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, ContentModule.SchemaName);

        return new ContentDbContext(builder.Options, new DesignTimeTenantContext());
    }
