...
internal sealed class PlatformDbContextFactory : IDesignTimeDbContextFactory<PlatformDbContext>
{
    ...
    public PlatformDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, PlatformModule.SchemaName);

        return new PlatformDbContext(builder.Options, new DesignTimeTenantContext());
    }
