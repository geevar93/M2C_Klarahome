...
internal sealed class ShippingDbContextFactory : IDesignTimeDbContextFactory<ShippingDbContext>
{
    ...
    public ShippingDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, ShippingModule.SchemaName);

        return new ShippingDbContext(builder.Options, new DesignTimeTenantContext());
    }
