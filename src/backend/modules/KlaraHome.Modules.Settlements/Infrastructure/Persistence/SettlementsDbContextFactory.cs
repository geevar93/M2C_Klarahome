...
/// </remarks>
internal sealed class SettlementsDbContextFactory : IDesignTimeDbContextFactory<SettlementsDbContext>
{
    ...
    public SettlementsDbContext CreateDbContext(string[] args)
    {
        ...
        var builder = new DbContextOptionsBuilder<SettlementsDbContext>();
        builder.ConfigureKlaraHome(provider: null, connectionString, SettlementsModule.SchemaName);

        return new SettlementsDbContext(builder.Options, new DesignTimeTenantContext());
    }
