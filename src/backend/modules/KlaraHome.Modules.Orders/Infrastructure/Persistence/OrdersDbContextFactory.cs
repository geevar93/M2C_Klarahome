...
internal sealed class OrdersDbContextFactory : IDesignTimeDbContextFactory<OrdersDbContext>
{
    ...
    public OrdersDbContext CreateDbContext(string[] args)
    {
        ...
        builder.ConfigureKlaraHome(provider: null, connectionString, OrdersModule.SchemaName);

        return new OrdersDbContext(builder.Options, new DesignTimeTenantContext());
    }
