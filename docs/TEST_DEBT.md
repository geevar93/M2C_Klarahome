...
| 22 | **Performance budgets are enforced and met** - `05-frontend-architecture.md` §3.4. Needs a gzipped-size check in `ci.ps1`, because Angular's budget mechanism measures raw bytes and the document states gzipped. Storefront is 81.6 kB gzipped today against a 180 kB budget | load | `tools/ci.ps1`, plus Lighthouse CI at Step 29 | 🟡 | ⬜ OPEN |
